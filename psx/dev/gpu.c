...
#define GPU_CYCLES_PER_SCANL_NTSC PSX_GPU_CYCLES_PER_SCANLINE_NTSC
#define GPU_SCANS_PER_VDRAW_NTSC 240
#define GPU_SCANS_PER_FRAME_NTSC PSX_GPU_SCANS_PER_FRAME_NTSC
#define GPU_CYCLES_PER_HDRAW_PAL 2560.0f
#define GPU_CYCLES_PER_SCANL_PAL PSX_GPU_CYCLES_PER_SCANLINE_PAL
#define GPU_SCANS_PER_VDRAW_PAL  288
#define GPU_SCANS_PER_FRAME_PAL  PSX_GPU_SCANS_PER_FRAME_PAL
